...
3. **Plain-language privacy statement.** Every capability's `privacy` field states exactly what is sent, e.g. *"Package names and versions (never source code) are sent to api.osv.dev."*
